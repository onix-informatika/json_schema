...
main() {
  ...
  var specFileHandlerWithCors =
      const Pipeline().addMiddleware(corsHeaders()).addHandler(specFileHandler);
  io.serve(specFileHandlerWithCors, 'localhost', 1234);

  final additionalRemotesHandler =
      createStaticHandler('test/additional_remotes');
  var additionalRemotesHandlerWithCors = const Pipeline()
      .addMiddleware(corsHeaders())
      .addHandler(additionalRemotesHandler);
